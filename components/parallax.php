...
<section class="pt4 pb4 shadow-inset parallax" data-speed="0.3" data-image="design/images/background.jpg">
  <div class="container">
    <div class="div white">
      ...
      <div class="btn-group">
        <a href="javascript:void(0)" class="btn btn-mt btn-primary ripple"><i class="fa fa-sun-o"></i>First Button</a>
        <a href="javascript:void(0)" class="btn btn-mt btn-danger ripple">Second Button</a>
      </div>
    </div>
  </div>
</section>
...
'<section class="pt4 pb4 shadow-inset parallax" data-speed="0.3" data-image="design/images/background.jpg">
  <div class="container">
    <div class="div white">
      ...
      <h2 class="mb2">This is parllax section</h2>
      <div class="btn-group">
        <a href="javascript:void(0)" class="btn btn-primary btn-mt ripple"><i class="fa fa-sun-o"></i>First Button</a>
        <a href="javascript:void(0)" class="btn btn-danger btn-mt ripple">Second Button</a>
      </div>
    </div>
  </div>
</section>';

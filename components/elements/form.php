<div id="form" class="navbar-target"></div>
...
<div class="hidden" id="select-autocomplete-code">
<?php
$code =
'<div class="form-group">
...
<div class="hidden" id="select-autocomplete-icon-code">
<?php
$code =
'<div class="form-group">
	<label for="">Select autocomplete</label>
...
<div class="hidden" id="select-multiple-code">
<?php
$code =
'<div class="form-group">
...
<div class="hidden" id="select-multiple-icon-code">
<?php
$code =
'<div class="form-group">
	<label for="">Select autocomplete (multiple)</label>

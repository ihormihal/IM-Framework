<section>
	<div class="container pt2 pb2">
		<h2 class="mb1">AJAX JSON Datatable<a class="show-code" href="#json-server-datatable-code"> <i class="fa fa-code"></i></a></h2>
		<h3 class="mb2 grey">Server-side pagination, searching and filtering</h3>
		<div
		im-datatable 
		server-side="true" 
...
<div class="hidden" id="json-server-datatable-code">
<?php
$code =
'<div
im-datatable
